  ...
  return (
    <div className="about-page">
      <section>
        <h2>О нас</h2>
        <p>
          Мы — команда специалистов, помогающая пациентам со всего мира получить
          качественное лечение в Израиле. Мы выступаем в роли посредников и
          сотрудничаем с одной из лучших клиник страны — <strong>Ассута</strong>
          , предоставляя полный комплекс сопровождения.
        </p>
      </section>
